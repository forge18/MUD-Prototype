...
for (const group of commandGroups) {
	...
	for (const file of commandFiles) {
		let command = require(path.join(__dirname, `./commands/${folder}/${file}`));
...
const commandSubGroups = fs.readdirSync(path.join(__dirname, `./commands/${group}`)).filter(subgroup=>!file.isDirectory, file => file.endsWith('.js'));
