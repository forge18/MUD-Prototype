    ...
    async execute(client, type, interaction) {    
        const embed = new MessageEmbed()
            ...
            .setDescription(
                ...
                '> **Stories** - \n' + 
                '> **Locations** - Create and update worlds, zones, and rooms. ("/help locations" for additional info)\n' + 
                '> **Characters** - Create and update enemies, npcs, and puppets. ("/help characters" for additional info)\n' + 
                '> **Objects** - \n' + 
                '> **Events** - '
                )
