    ...
    async execute(client, type, interaction) {    
        const embed = new MessageEmbed()
            ...
            .setDescription(
                ...
                '> **Stories** - Set up an adventure that uses the locations, characters, object, and events that you have created. ("/help stories")\n\n' + 
                '> **Locations** - Create and edit worlds, zones, and rooms. ("/help locations")\n\n' + 
                '> **Characters** - Create and edit enemies, npcs, and puppets. ("/help characters")\n\n' + 
                '> **Objects** - Create and edit equipment, furniture and other items. ("/help objects")\n\n' + 
                '> **Events** - Add a trigger and resulting event to a location, character or object. ("/help events")'
                )
